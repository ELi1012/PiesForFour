...
if (keyboard_check_pressed(ord("E"))) {
	...
	if (new_order) new_order = false;
}

// #problem orders not removing properly
...
// cycle through list if clicked
// does not check if list is fully in view because annoying
if (in_view and mouse_check_button_pressed(mb_left) and tables_ordered > 0) {
	//show_debug_message(" ");
